          ...
          <div className={styles.timeline__event__content}>
            <div className={styles.timeline__event__description}>
              <p>
                ...
                "Maverick WM" project, I feel incredibly fortunate to have been
                chosen, and I am excited to contribute my skills and expertise
                to this innovative project. I am honored to have the opportunity
                to work alongside some of the brightest minds in the industry,
                and I am eager to see what we can achieve together on this
